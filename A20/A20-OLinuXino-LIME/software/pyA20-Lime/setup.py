...
modules = [
    Extension('pyA20Lime.gpio.gpio', sources=['pyA20Lime/gpio/gpio_lib.c', 'pyA20Lime/gpio/gpio.c']),

    Extension('pyA20Lime.i2c', sources=['pyA20Lime/i2c/i2c_lib.c', 'pyA20Lime/i2c/i2c.c']),

    Extension('pyA20Lime.spi', sources=['pyA20Lime/spi/spi_lib.c', 'pyA20Lime/spi/spi.c']),

    Extension('pyA20Lime.gpio.connector', sources=['pyA20Lime/gpio/connector/connector.c']),

    Extension('pyA20Lime.gpio.port', sources=['pyA20Lime/gpio/port/port.c']),
...
setup(
    ...
    license='MIT',
    packages=['pyA20Lime', 'pyA20Lime.gpio'],
