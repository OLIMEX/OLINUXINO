LCD-OLINUXINO-15.6 and LCD-OLINUXINO-15.6FHD started as separate designs but starting hardware revision E, both board use the design files (the design of LCD-OLINUXINO-15.6FHD).
