...
extern void I2C_Open(int *fd, unsigned char address);
extern void I2C_Close(int *fd);
extern int I2C_Send(int *fd, unsigned char *buffer, unsigned char num_bytes);
extern int I2C_Read(int *fd, unsigned char *buffer, unsigned char num_bytes);
