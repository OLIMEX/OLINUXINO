...
In order to get the URL, go to GitHUB find the directory of the project: <path>; select the file you want to download and click on the "Raw" button; then copy the URL and trigger the command (wget) in the console of A20-OLinuXino-Micro. Do this for the four files: makefile; i2c.c; i2c.h; RGB.c.
