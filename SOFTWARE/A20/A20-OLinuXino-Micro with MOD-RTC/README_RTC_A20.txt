This is a tutorial how to build a simple project for A20-OLinuXino-Micro Rev.F with demo for MOD-RTC Rev.A.
...
which IS NOT correct data since the date and time aren't set yet!

11) Execute it again but this time with WRITE option. Thus we will synchronise the time on the MOD-RTC with the one on the host board
Input:
...
The function "localtime" (which the host board uses) counts the years after 1900. For more information: http://linux.die.net/man/3/localtime