...
modules = [
    Extension('pyA20Lime2.gpio.gpio', sources=['pyA20Lime2/gpio/gpio_lib.c', 'pyA20Lime2/gpio/gpio.c']),

    Extension('pyA20Lime2.i2c', sources=['pyA20Lime2/i2c/i2c_lib.c', 'pyA20Lime2/i2c/i2c.c']),

    Extension('pyA20Lime2.spi', sources=['pyA20Lime2/spi/spi_lib.c', 'pyA20Lime2/spi/spi.c']),

    Extension('pyA20Lime2.gpio.connector', sources=['pyA20Lime2/gpio/connector/connector.c']),

    Extension('pyA20Lime2.gpio.port', sources=['pyA20Lime2/gpio/port/port.c']),
...
setup(
    ...
    license='MIT',
    packages=['pyA20Lime2', 'pyA20Lime2.gpio'],
