...
Before using this package we recommend reading the article at the [Olimex wiki](https://www.olimex.com/wiki/A20-SOM).
...
```python
from pyA20SOM.gpio import port
dir(port)
```
...
```python
from pyA20SOM.gpio import connector
dir(connector)
```
...
from pyA20SOM.gpio import gpio
from pyA20SOM.gpio import port
from pyA20SOM.gpio import connector
