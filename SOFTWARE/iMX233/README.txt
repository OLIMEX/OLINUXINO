...
defconfig is the default Open Embedded Kernel configuration for the SD image we use with TV console endabled
i2c-mxs.patch adds I2C hardware support to the kernel
