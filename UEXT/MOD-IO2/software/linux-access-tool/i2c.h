...
extern unsigned char I2C_Send(int *f, unsigned char *buffer, unsigned char num_bytes);
extern unsigned char I2C_Read(int *f, unsigned char *buffer, unsigned char num_bytes);
